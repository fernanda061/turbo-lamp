...
<!--    Datatables  -->
  ...
  <body>
    ...
    <div class="container">
       <div class="row">
           <div class="col-lg-12">
            <table id="eventos" class="table-striped table-bordered" style="width:100%">
                <thead class="text-center">
                    <th>ID</th>
                    <th>Fecha</th>
                    <th>Folio CDT</th>                               
                    <th>Folio CDT Salida</th>  
                    <th>Evento</th>
                    <th>Movimiento</th>
                    <th>Usuario</th>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $eventos['FolioCdt']?></td>
                        <td><?php echo $eventos['FolioCdtSalida']?></td>
                        <td><?php echo $eventos['Evento']?></td>
                        <td><?php echo $eventos['Movimiento']?></td>
                        <td><?php echo $eventos['Usuario']?></td>
                    </tr>
                    <?php
                        }
                    ?>
